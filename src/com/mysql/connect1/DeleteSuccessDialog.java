...
public class DeleteSuccessDialog extends JFrame {
    public void init(){
        Container container = this.getContentPane();
        container.setLayout(null);

        JLabel label = new JLabel(Const.DELETE_SUCCESS_DIALOG_LABEL_TEXT);
        ...
        this.setTitle(Const.DELETE_SUCCESS_DIALOG_TITLE_TEXT);
